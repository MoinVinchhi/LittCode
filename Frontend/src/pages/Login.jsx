...
function Login() {
    ...
    return (
        <>
            <form onSubmit={handleSubmit(onSubmit)} className='min-h-screen flex justify-center items-center bg-base-200 p-4'>
                <div className="w-full max-w-md p-8 bg-base-100 shadow-lg rounded-lg">
                    ...
                    <div className="form-control mb-6">
                        ...
                        <input
                            ...
                            className={`input input-bordered w-full bg-base-200 border text-accent-content placeholder-gray-500 ${errors.emailId ? 'input-error border-error' : ''}`}
                        />
                        {errors.emailId && (
                            <label className="label">
                    ...
                    <div className="form-control mb-6">
                        ...
                        <div className='relative'>
                            <input
                                ...
                                placeholder="••••••••"
                                className={`input input-bordered w-full bg-base-200 border text-accent-content placeholder-gray-500 ${errors.password ? 'input-error border-error' : ''}`}
                            />
                            <button
                                type="button"

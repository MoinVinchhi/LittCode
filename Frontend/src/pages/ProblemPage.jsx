            ...
            <>
              {activeLeftTab === 'description' && (
                <div>
                  <div className="flex items-center gap-4 mb-6">
                    ...
                    <div className={`badge badge-outline text-green-400 ${getDifficultyColor(problem.difficulty.toLowerCase())}`}>
                      {problem.difficulty}
                    </div>
              ...
              {activeLeftTab === 'chatAI' && (
                <div className='prose max-w-none h-full'>
                  ...
                  <div className="whitespace-pre-wrap mb-0 text-sm leading-relaxed">
          ...
          <div className="p-4 border-t border-base-300 flex justify-between items-center">
            <div className="flex gap-2">
              {activeRightTab === 'code' ? 
                <div>
                  <button 
                  className="btn btn-ghost btn-sm text-sm flex items-center justify-center"
                  onClick={() => setActiveRightTab('testcase')}
                  >
                    <span className='mb-[1%]'>Console</span>
                    <Terminal size={20} />
                  </button>
                </div>:<div>
                  <button 
            ...
            <div className="flex gap-4 pr-2">
              <div className={`btn-ghost btn-sm ${loading ? 'loading' : ''}`}></div>
              <button
                className={`btn btn-outline w-15 btn-sm`}
                onClick={handleRun}
                disabled={loading}
              >
                Run

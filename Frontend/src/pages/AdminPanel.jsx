  ...
  return (
    <div className="min-h-screen bg-base-200">
      <div className="container mx-auto px-4 py-8">
        ...
        {/* Admin Options Grid */}
        <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-2 px-6 gap-8 max-w-6xl mx-auto">
          {adminOptions.map((option) => {
            const IconComponent = option.icon;
            return (
              <div
                key={option.id}
                className="card bg-base-100 shadow-lg hover:shadow-xl transition-all duration-400 transform hover:-translate-y-1"
              >
